...
var require = {
	app: {
		analytics: true,
		copyright: "2012 by ivc1215adm",
		deployType: "development",
		description: "not specified",
		guid: "25b8bd5f-fad5-4336-9119-e4bbf0ed080b",
		id: "2V8VB59376.com.flair.flair11",
		name: "Flair",
		names: {},
		publisher: "HGadiraju",
		url: "http://flair.me",
...
require("Ti/App/Properties", function(p) {
	p.setString("acs-oauth-secret-development","I35zE886z7j41lZnk8Y1jjMi7EN0NB4r");
	p.setString("acs-oauth-key-development","NoOvhxdG6DHMIZMixiFxNigzAJvEhPkS");
	p.setString("acs-api-key-development","PXoSQeWvDkJ0gUArBIhcXMggvmWwnOyL");
	p.setString("acs-oauth-secret-production","KeULCsUmhv6TIwghPeXFFademJ0sPoIY");
	p.setString("acs-oauth-key-production","53CTV3WmOh0HUlNW6B0M4XgYJblsVuHa");
	p.setString("acs-api-key-production","fZuIdM1Un78R1BORAdrfGTNbkdh1Udwb");
	p.setString("ti.ui.defaultunit","system");
	p.setString("ti.map.apikey","AIzaSyAZjPLQEq5tdllUCd89gV1_XFBHdjpmmEI");
});
