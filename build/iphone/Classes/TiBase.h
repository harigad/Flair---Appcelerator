...
// in simulator we redefine to format for Flair Developer console
...
{\
	NSString * exceptionName = [@"org.flair." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.flair";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIFlairNativeItemNone = -1, 
	UIFlairNativeItemSpinner = -2,
	UIFlairNativeItemProgressBar = -3,
	
	UIFlairNativeItemSlider = -4,
	UIFlairNativeItemSwitch = -5,
	UIFlairNativeItemMultiButton = -6,
	UIFlairNativeItemSegmented = -7,
	
	UIFlairNativeItemTextView = -8,
	UIFlairNativeItemTextField = -9,
	UIFlairNativeItemSearchBar = -10,
	
	UIFlairNativeItemPicker = -11,
	UIFlairNativeItemDatePicker = -12,
	
	UIFlairNativeItemInfoLight = -13,
	UIFlairNativeItemInfoDark = -14,
	
	UIFlairNativeItemDisclosure = -15,
	
	UIFlairNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all Flair instances of
